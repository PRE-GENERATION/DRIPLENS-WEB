        ...
        <div className="bg-white border-t border-[#F0F0F0] p-6 shrink-0">
          <form onSubmit={handleSend} className="w-full flex items-center gap-4">
            ...
            <input 
              ...
              className="flex-1 bg-transparent border-none text-[#111] py-2 outline-none text-sm font-normal"
            />
            <button 
              type="submit" 
              disabled={!newMessage.trim()}
              className="text-[#111] disabled:text-[#DDD] transition-colors flex items-center justify-center shrink-0"
            >
